...
const NewsPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("https://newsapi.org/v2/everything?q=tesla&from=2023-12-31&sortBy=publishedAt&apiKey=db341db25dbe42aaaa78499b4f2f6ea4");
  ...
  return (
    ...
    <Image height={500} width={2000} src="/assets/images/topsecimg/news-2.jpg"></Image>
